...
class BamlAsyncClient:
    ...
    async def ExtractDataset(
      ...
      return cast(types.Links, raw.cast_to(types, types, partial_types, False))
    
    async def ExtractPage(
        self,
        page: str,
        baml_options: BamlCallOptions = {},
    ) -> types.Page:
      ...
      return cast(types.Page, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ExtractDataset(
        ...
        pagecontent: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Links, types.Links]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.Links, types.Links](
        raw,
        lambda x: cast(partial_types.Links, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.Links, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def ExtractPage(
      ...
      return baml_py.BamlStream[partial_types.Page, types.Page](
        raw,
        lambda x: cast(partial_types.Page, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.Page, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
